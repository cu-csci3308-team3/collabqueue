...
values
('Travis Scott - SICKO MODE (Audio)', 'https://www.youtube.com/watch?v=d-JBBNg8YKs', 'RAPXX', 0, 'UserOne', now()),
...
('High Hopes', 'https://www.youtube.com/watch?v=GJY8OMJXRAk', 'ALTXX', 0, 'UserFour', now()),
('Happier', 'https://www.youtube.com/watch?v=QgKYZWRH4DA', 'ALTXX', 0, 'UserFive', now()),
('My Blood', 'https://www.youtube.com/watch?v=0a2ePzVCKuk', 'ALTXX', 0, 'UserSix', now()),
('Meant to Be (feat. Florida Georgia Line)', 'https://www.youtube.com/watch?v=cU36WSG-XjI', 'CNTRY', 0, 'UserSeven', now()),
('Luke Combs - She Got the Best of Me (Audio)', 'https://www.youtube.com/watch?v=sD3kO4U5Oh4', 'CNTRY', 0, 'UserEight', now()),
('Dan + Shay - Tequila (Audio)', 'https://www.youtube.com/watch?v=vTNWM0aD4JY', 'CNTRY', 0, 'UserNine', now());